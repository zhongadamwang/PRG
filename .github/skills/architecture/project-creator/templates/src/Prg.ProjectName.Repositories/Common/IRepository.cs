namespace Prg.ProjectName.Repositories.Common
{
	...
	{
		System.Threading.Tasks.Task<Prg.ProjectName.Core.Common.PagerResult<TEntity>> GetPagedListAsync(Prg.ProjectName.Core.Common.Pager pager, System.Linq.Expressions.Expression<Func<TEntity, bool>> expression);
