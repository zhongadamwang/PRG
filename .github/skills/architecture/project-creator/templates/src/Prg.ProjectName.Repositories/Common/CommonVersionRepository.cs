...
#pragma warning disable SA1401 // FieldsMustBePrivate
		protected readonly Prg.ProjectName.Core.Services.ICurrentUserService _currentUserService;
#pragma warning restore SA1401 // FieldsMustBePrivate

		public CommonVersionRepository(TIDataService dataService, Prg.ProjectName.Core.Services.ICurrentUserService currentUserService)
			: base(dataService)
		{
