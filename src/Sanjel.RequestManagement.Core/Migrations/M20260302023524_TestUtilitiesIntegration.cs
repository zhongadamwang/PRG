...
/// <summary>
/// Database migration: TestUtilitiesIntegration
/// Generated from domain model metadata
/// </summary>
public partial class M20260302023524_TestUtilitiesIntegration : Migration
{
    /// <summary>
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                RequestId = table.Column<string>(type: "nvarchar(255)", nullable: false),
                Status = table.Column<int>(type: "int", nullable: false),
                CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                Priority = table.Column<int>(type: "int", nullable: false),
                ClientId = table.Column<string>(type: "nvarchar(255)", nullable: false),
                SourceEmail = table.Column<string>(type: "nvarchar(255)", nullable: false),
                AssignedEngineerId = table.Column<string>(type: "nvarchar(255)", nullable: false),
                AssignedBy = table.Column<string>(type: "nvarchar(255)", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                RawValue = table.Column<string>(type: "nvarchar(255)", nullable: false),
                ValidatedValue = table.Column<string>(type: "nvarchar(255)", nullable: false),
                ValidationStatus = table.Column<int>(type: "int", nullable: false),
                SourceLocation = table.Column<string>(type: "nvarchar(255)", nullable: false),
                ValidationNotes = table.Column<string>(type: "nvarchar(255)", nullable: false),
                StateDiagramId = table.Column<int>(type: "int", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                DiagramId = table.Column<string>(type: "nvarchar(255)", nullable: false),
                DiagramName = table.Column<string>(type: "nvarchar(255)", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                PackageId = table.Column<string>(type: "nvarchar(255)", nullable: false),
                RequestId = table.Column<string>(type: "nvarchar(255)", nullable: false),
                SubmittingEngineerId = table.Column<string>(type: "nvarchar(255)", nullable: false),
                AssignedReviewerId = table.Column<string>(type: "nvarchar(255)", nullable: false),
                SubmissionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ReviewCompletionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ReviewStatus = table.Column<int>(type: "int", nullable: false),
                WorkSummary = table.Column<string>(type: "nvarchar(255)", nullable: false),
                ReviewFeedback = table.Column<string>(type: "nvarchar(255)", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                NotificationId = table.Column<string>(type: "nvarchar(255)", nullable: false),
                RequestId = table.Column<string>(type: "nvarchar(255)", nullable: false),
                ...
                ActionButtons = table.Column<string>(type: "nvarchar(255)", nullable: false)
            },
            constraints: table =>
            {
