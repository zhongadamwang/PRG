...
[TestFixture]
public class StickDiagramTemplateRepositoryTests
{
	private Mock<IDataService> _mockDataService;
	private Mock<ICurrentUserService> _mockCurrentUserService;
	private StickDiagramTemplateRepository _repository;
	...
	public void SetUp()
	{
		...
		_repository = new StickDiagramTemplateRepository(_mockDataService.Object, _mockCurrentUserService.Object);
	}

	[Test]
	public void Constructor_WithDataServiceAndCurrentUserService_InitializesRepository()
	{
		// Arrange & Act - performed in SetUp

		// Assert
		Assert.That(_repository, Is.Not.Null);
		Assert.That(_repository, Is.InstanceOf<IStickDiagramTemplateRepository>());
	}
	...
	public async Task GetByIdAsync_WithValidId_ReturnsEntityAsync()
	{
		// Arrange
		var expectedId = 1;
		var expectedEntity = new Entity { Id = expectedId, Name = "Test Template" };
		...
		Assert.That(result.Name, Is.EqualTo("Test Template"));
	...
	public async Task GetPagedListAsync_WithPagerAndExpression_ReturnsPagedResultAsync()
	{
		...
		var entities = new List<Entity>
				{
						new Entity { Id = 1, Name = "Template 1" },
						new Entity { Id = 2, Name = "Template 2" }
				};
	...
	[Test]
	public async Task CreateAsync_WithValidEntity_SetsModifiedUserNameAndReturnsTrueAsync()
	{
		// Arrange
		var expectedUsername = "testuser";
		var entity = new Entity { Name = "New Template" };
		...
		_mockCurrentUserService.Verify(x => x.GetCurrentUsername(), Times.Once);
		_mockDataService.Verify(x => x.Insert(It.Is<Entity>(e => e.ModifiedUserName == expectedUsername), false), Times.Once);
	}
	...
	public async Task CreateAsync_WithNullEntity_ReturnsFalseAsync()
	{
		...
		_mockCurrentUserService.Verify(x => x.GetCurrentUsername(), Times.Never);
		_mockDataService.Verify(x => x.Insert(It.IsAny<Entity>(), It.IsAny<bool>()), Times.Never);
	}

	[Test]
	public async Task CreateWithChildrenAsync_WithValidEntity_SetsModifiedUserNameAndReturnsTrueAsync()
	{
		// Arrange
		var expectedUsername = "testuser";
		var entity = new Entity { Name = "New Template" };
		...
		Assert.That(result, Is.True);
		_mockCurrentUserService.Verify(x => x.GetCurrentUsername(), Times.Once);
		_mockDataService.Verify(x => x.Insert(It.Is<Entity>(e => e.ModifiedUserName == expectedUsername), true), Times.Once);
	}

	[Test]
	public async Task UpdateAsync_WithValidEntity_SetsModifiedUserNameAndReturnsTrueAsync()
	{
		// Arrange
		var expectedUsername = "testuser";
		var entity = new Entity { Id = 1, Name = "Updated Template" };
		...
		Assert.That(result, Is.True);
		_mockCurrentUserService.Verify(x => x.GetCurrentUsername(), Times.Once);
		_mockDataService.Verify(x => x.Update(It.Is<Entity>(e => e.ModifiedUserName == expectedUsername), false), Times.Once);
	}
	...
	[Test]
	public async Task UpdateWithChildrenAsync_WithValidEntity_SetsModifiedUserNameAndReturnsTrueAsync()
	{
		// Arrange
		var expectedUsername = "testuser";
		var entity = new Entity { Id = 1, Name = "Updated Template" };
		...
		Assert.That(result, Is.True);
		_mockCurrentUserService.Verify(x => x.GetCurrentUsername(), Times.Once);
		_mockDataService.Verify(x => x.Update(It.Is<Entity>(e => e.ModifiedUserName == expectedUsername), true), Times.Once);
	}

	[Test]
	public async Task DeleteAsync_WithValidEntity_SetsModifiedUserNameAndReturnsTrueAsync()
	{
		// Arrange
		var expectedUsername = "testuser";
		var entity = new Entity { Id = 1, Name = "Template to Delete" };
		...
		Assert.That(result, Is.True);
		_mockCurrentUserService.Verify(x => x.GetCurrentUsername(), Times.Once);
		_mockDataService.Verify(x => x.Delete(It.Is<Entity>(e => e.ModifiedUserName == expectedUsername), false), Times.Once);
	}
	...
	[Test]
	public async Task DeleteWithChildrenAsync_WithValidEntity_SetsModifiedUserNameAndReturnsTrueAsync()
	{
		// Arrange
		var expectedUsername = "testuser";
		var entity = new Entity { Id = 1, Name = "Template to Delete" };
		...
		Assert.That(result, Is.True);
		_mockCurrentUserService.Verify(x => x.GetCurrentUsername(), Times.Once);
		_mockDataService.Verify(x => x.Delete(It.Is<Entity>(e => e.ModifiedUserName == expectedUsername), true), Times.Once);
	}
		...
		var entities = new List<Entity>
				{
						new Entity { Id = 1, Name = "Template 1" },
						new Entity { Id = 2, Name = "Template 2" },
						new Entity { Id = 3, Name = "Template 3" }
				};
	...
	[Test]
	public async Task CreateAsync_CallFailsOnDataService_ReturnsFalseAsync()
	{
		// Arrange
		var expectedUsername = "testuser";
		var entity = new Entity { Name = "New Template" };
		...
		// Assert
		Assert.That(result, Is.False);
		_mockDataService.Verify(x => x.Insert(It.IsAny<Entity>(), false), Times.Once);
	}

	[Test]
	public async Task UpdateAsync_CallFailsOnDataService_ReturnsFalseAsync()
	{
		// Arrange
		var expectedUsername = "testuser";
		var entity = new Entity { Id = 1, Name = "Updated Template" };
		...
		// Assert
		Assert.That(result, Is.False);
		_mockDataService.Verify(x => x.Update(It.IsAny<Entity>(), false), Times.Once);
	}

	[Test]
	public async Task DeleteAsync_CallFailsOnDataService_ReturnsFalseAsync()
	{
		// Arrange
		var expectedUsername = "testuser";
		var entity = new Entity { Id = 1, Name = "Template to Delete" };
		...
		// Assert
		Assert.That(result, Is.False);
		_mockDataService.Verify(x => x.Delete(It.IsAny<Entity>(), false), Times.Once);
	}
}